  ...
  if (req.method === 'POST') {
    try {
      ...
      const tweetPrompt = `${
        ...
        `Summarize the following conversation in a tweet format, keeping it concise and engaging. Make sure the content returned is less than 150 characters and valid to tweet.
