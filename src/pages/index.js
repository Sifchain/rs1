import { ChakraProvider, Box, Heading, Flex, Button, Text } from '@chakra-ui/react';
      ...
      <ChakraProvider>
        ...
        <Box position="relative" height="100vh" bg="#f0f4f8">
          <Flex alignItems="center" justifyContent="center" height="100vh">
            <Heading fontSize="4xl" color="#3498db" textShadow="0 0 10px #3498db" fontFamily="Arial, sans-serif">
  ...
  return (
    <ChakraProvider>
      ...
      <Box display="flex" flexDirection="column" minHeight="100vh">
        ...
        <Flex flex="1" bg="#f0f4f8" color="#34495e" py={10} px={6} justifyContent="center" alignItems="center" textAlign="center">
          <Box>
            <Heading mb={6} fontSize={{ base: "4xl", md: "6xl" }} color="#2c3e50" fontFamily="Arial, sans-serif">
              Reality Spiral
            </Heading>
            <Text mb={8} fontSize={{ base: "lg", md: "2xl" }} fontFamily="Arial, sans-serif" maxWidth="600px" color="#2c3e50">
              A unique platform to create, explore, and connect with agents and backrooms in the digital dimension.
            </Text>
