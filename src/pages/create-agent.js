import { ChakraProvider, Box, Button, Heading, VStack, Flex, Input, Textarea, Text, FormControl, FormErrorMessage } from '@chakra-ui/react';
        ...
        <Box py={10} px={6} maxW="800px" mx="auto">
              ...
              <VStack spacing={4} align="stretch">
                ...
                <FormControl isInvalid={errors.focus}>
                  <Textarea
                    ...
                    p={4}
                  />
                  {errors.focus && <FormErrorMessage>{errors.focus}</FormErrorMessage>}
                </FormControl>
              </VStack>
          ...
          {loadingStep > 0 && loadingStep < 3 && (
            <Box textAlign="center">
              {loadingStep === 1 && (
                <>
                  <Heading fontSize="2xl" mb={4}>Contacting Spiral Reality AI...</Heading>
                  <Text>Sending agent information to the Spiral Reality AI for processing...</Text>
                </>
              )}

              {loadingStep === 2 && (
                <>
                  <Heading fontSize="2xl" mb={4}>Checking Wallet Address Requirements...</Heading>
                  <Text>Validating wallet address and ensuring eligibility...</Text>
                </>
              )}
            </Box>
          )}
          ...
          {loadingStep === 3 && (
            <Box textAlign="center">
              <Heading fontSize="2xl" mb={4}>Agent Successfully Created!</Heading>
              <Text mb={6}>Your agent has been created. You're ready to create your first Backroom!</Text>
              <Button
